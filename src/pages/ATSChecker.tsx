...
const ATSChecker = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>ATS Resume Checker - MakeMyCV</title>
        <meta name="description" content="Analyze your resume for ATS compatibility and get improvement tips. Free instant score with actionable suggestions." />
        <link rel="canonical" href="https://makemycv.lovable.app/ats-checker" />
        <meta property="og:title" content="ATS Resume Checker - MakeMyCV" />
        <meta property="og:url" content="https://makemycv.lovable.app/ats-checker" />
      </Helmet>
